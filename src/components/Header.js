...
const Header = (props) => {
  ...
  return ( 
    <Nav>
      <Logo>
        <img src='/images/anibase-logo.png' alt='anibase' />
      </Logo>
      <NavMenu>
        <a href='/'>
        ...
        <a href='anime'>
          <img src="/images/anime.svg" alt="ANIME" />
          <span>ANIME</span>
        </a>
        <a href='manga'>
          <img src="/images/MANGA.svg" alt="MANGA" />
          <span>MANGA</span>
        </a>
        <a href='movies'>
      ...
      {!userName ? (<Login onClick={() => history('/login')}>Login</Login>) : (
      <SignOut>
